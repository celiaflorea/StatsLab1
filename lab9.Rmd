...
file<-system.file("data"("When_not_choosing_leads_to_not_liking_Data", package = "xlsx"))
...
the_data <- read.csv(file="lab9/infant_choice_data.csv","When_not_choosing_leads_to_not_liking_Data", header = TRUE)
