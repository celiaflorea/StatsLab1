...
```
The probability of finding a sample mean greater than 50 within the specified population parameters is very small (p=4.570531e-13). This makes sense since with a population mean of 40 and sigma/standard deviation of 7, the sample mean of 50 is already more than one whole standard deviation from the population mean. (The substantial difference between population and sample means is likely due to the smallish sample size of n=25.)
```{r}
